...
public class Today_Mission_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        System.out.println("user_id투데이미션프레그먼트 = " + user_id);
        bundle = new Bundle();
        ...
        callMission.enqueue(new Callback<List<MissionVO>>() {
            ...
            public void onResponse(Call<List<MissionVO>> call, Response<List<MissionVO>> response) {
                ...
                if (char_image1 != null && !char_image1.equals("")) {
                    ...
                    System.out.println("vo보드어댑터 이미지리스트 나오냐 = " + missionVO1.getM_image());
                } else {
                ...
                cardView1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        System.out.println("missionVO1.getMission_code() = " + missionVO1.getMission_code());
                ...
                if (char_image2 != null && !char_image2.equals("")) {
                    ...
                    System.out.println("vo보드어댑터 이미지리스트 나오냐 = " + missionVO2.getM_image());
                } else {
                ...
                cardView2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        System.out.println("strcode = " + strcode);
                        System.out.println("user_id = " + user_id);
                        System.out.println("missionVO1.getMission_code() = " + missionVO2.getMission_code());
                    }
                });
                ...
                if (char_image3 != null && !char_image3.equals("")) {
                    ...
                    System.out.println("vo보드어댑터 이미지리스트 나오냐 = " + missionVO3.getM_image());
                } else {
                ...
                cardView3.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        System.out.println("strcode = " + strcode);
                        System.out.println("user_id = " + user_id);
                        System.out.println("missionVO1.getMission_code() = " + missionVO3.getMission_code());
                    }
                });
                ...
                if (char_image4 != null && !char_image4.equals("")) {
                    ...
                    System.out.println("vo보드어댑터 이미지리스트 나오냐 = " + missionVO4.getM_image());
                } else {
                ...
                cardView4.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        System.out.println("strcode = " + strcode);
                        System.out.println("user_id = " + user_id);
                        System.out.println("missionVO1.getMission_code() = " + missionVO4.getMission_code());
                    }
                });
                ...
                if (char_image5 != null && !char_image5.equals("")) {
                    ...
                    System.out.println("vo보드어댑터 이미지리스트 나오냐 = " + missionVO5.getM_image());
                } else {
                ...
                cardView5.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        System.out.println("strcode = " + strcode);
                        System.out.println("user_id = " + user_id);
                        System.out.println("missionVO1.getMission_code() = " + missionVO5.getMission_code());
                    }
                });
                ...
                if (char_image6 != null && !char_image6.equals("")) {
                    ...
                    System.out.println("vo보드어댑터 이미지리스트 나오냐 = " + missionVO6.getM_image());
                } else {
                ...
                cardView6.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        System.out.println("strcode = " + strcode);
                        System.out.println("user_id = " + user_id);
                        System.out.println("missionVO1.getMission_code() = " + missionVO6.getMission_code());
                    }
                });
