    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_pati_mission.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("userid =/////미션참가 클릭 아이디 " + userid);
...
//                        System.out.println("UMvo = " + UMvo);
//                        System.out.println("um_user_id = " + um_user_id);
//                        System.out.println("Bmp = " + Bmp);
//                        System.out.println("response.code() //////=미션완료 " + response.code());
