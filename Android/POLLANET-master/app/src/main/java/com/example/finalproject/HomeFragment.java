...
//        Glide.with(this).load(R.raw.ozoni_egg).into(imageView);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("intent = " + userID);
        ...
        charCall.enqueue(new Callback<User_charVO>() {
            ...
            public void onResponse(Call<User_charVO> call, Response<User_charVO> response) {
                ...
                System.out.println("response//////////////////////홈프 = " + response.body());
                System.out.println("response//////////////////////홈프 = " + response.toString());
...
//                    imageView.setClickable(false);
                ...
                System.out.println("................str.." + strImage);
                ...
                if (strImage != null && !strImage.equals("")) {
                    ...
                    System.out.println("홈프레그먼트 캐릭터이미지 이미지 = " + UVO.getCharacter_image());
                }
