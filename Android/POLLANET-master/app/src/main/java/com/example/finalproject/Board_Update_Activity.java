...
public class Board_Update_Activity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        switch (requestCode) {
            case CALL_GALLERY: //앨범
                ...
                cursor.close();
                System.out.println("이미지경로........." + strImage1);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("userId ...................= " + user_ID +"/..............."+ board_code);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("category_result = " + category_result);
            }
        });
                ...
                box.setNegativeButton("카메라", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            ...
                            System.out.println("카메라error...............:" + e.toString());
                        }
                    }
                });
                box.show();
