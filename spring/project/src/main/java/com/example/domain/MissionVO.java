...
public class MissionVO extends UserStatusVO{
	...
	public String toString() {
		return "MissionVO [mission_code=" + mission_code + ", m_start_Date=" + m_start_Date + ", m_last_Date="
				...
				+ ", m_target=" + m_target + ", m_result=" + m_result + ", m_get_point=" + m_get_point + ", m_user_id="
				+ m_user_id + ", m_sort=" + m_sort + "]";
	}
