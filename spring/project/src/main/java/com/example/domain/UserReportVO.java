...
public class UserReportVO {
	...
	public String toString() {
		return "UserReportTableVO [user_report_code=" + user_report_code + ", reporter_id=" + reporter_id
				+ ", report_board_code=" + report_board_code + ", report_comment_code=" + report_comment_code
